...
void datalogging::logging::publish_log_state() {
    ...
    msg.open_logs = self.logs_open;
    msg.close_logs = self.logs_closed;
    msg.clear_logs = self.logs_cleared;
