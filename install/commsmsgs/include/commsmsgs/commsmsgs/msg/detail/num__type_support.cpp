...
{
  new (message_memory) commsmsgs::msg::Num(_init);
}

void Num_fini_function(void * message_memory)
{
  auto typed_message = static_cast<commsmsgs::msg::Num *>(message_memory);
  typed_message->~Num();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Num_message_member_array[1] = {
  {
    ...
    offsetof(commsmsgs::msg::Num, num),  // bytes offset in struct
...
get_message_type_support_handle<commsmsgs::msg::Num>()
{
  return &::commsmsgs::msg::rosidl_typesupport_introspection_cpp::Num_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, commsmsgs, msg, Num)() {
  return &::commsmsgs::msg::rosidl_typesupport_introspection_cpp::Num_message_type_support_handle;
}
